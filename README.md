...
一款记录人生记忆的应用，支持文字、语音、图片、视频、全景图片、全景视频、高斯泼溅等方式记录记忆内容。

由于数据数据存储在手机，考虑到手机容量情况，应节约存储，您需要存储空间大一些的手机，记录内容会越来越多的，故此本应用适合轻量级使用，影像媒体内容建议最好是几十MB体积大小的，不仅是指普通视频，也指全景视频\高斯泼溅，对于观看影像记忆，大概去看下影像记忆也行，清晰度可以不必太在意，当然要看个人能否接受这种选择，对于某些媒体您需要清晰的，您可以自行将媒体处理成符合您要求的最低清晰度，仍然不建议媒体文件过大，比如体积到达GB大小，这是很不建议的，原始媒体文件你可以自行备份到其它地方。

推荐至少512GB存储的手机，为什么建议至少这个存储容量？记录会变得越来越多，很多人的256GB存储容量的手机可能往往剩余不了多少空间，当然如果剩余空间去掉一些预留的还有50GB当然也可以使用，50GB够你用也行。
